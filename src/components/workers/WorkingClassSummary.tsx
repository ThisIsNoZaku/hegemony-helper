...
export function WorkingClassSummary({
    ...
    const [_specialCardDialogOpen, _setSpecialCardDialogOpen] = useState(false);
    ...
    return <>
        <Grid container columns={4} spacing={2}>
            ...
            <Grid container columns={5} sx={{width: "100%"}} spacing={1}>
                ...
                <Grid size={1}>
                    <Button sx={{backgroundColor: "#84a751"}} onClick={() => dispatch!(workingClass.update.unions({
                        food: !wc.unions.food
                    }))}>
                ...
                <Grid size={1}>
                    <Button sx={{backgroundColor: "#02abe5"}} onClick={() => dispatch!(workingClass.update.unions({
                        luxuries: !wc.unions.luxuries
                    }))}>
                        <PersonIcon sx={{color: wc.unions["luxuries"] ? "#6ee3ff" : "#555555"}}/>
                    </Button>
                </Grid>
                <Grid size={1}>
                    <Button sx={{backgroundColor: "#e31722"}} onClick={() => dispatch!(workingClass.update.unions({
                        health: !wc.unions.health
                    }))}>
                        <PersonIcon sx={{color: wc.unions["health"] ? "white" : "#555555"}}/>
                    </Button>
                </Grid>
                <Grid size={1}>
                    <Button sx={{backgroundColor: "#ffad22"}} onClick={() => dispatch!(workingClass.update.unions({
                        education: !wc.unions.education
                    }))}>
                        <PersonIcon sx={{color: wc.unions["education"] ? "#ffed4c" : "#555555"}}/>
                    </Button>
                </Grid>
                <Grid size={1}>
                    <Button sx={{backgroundColor: "#a62ea4"}} onClick={() => dispatch!(workingClass.update.unions({
                        ...wc.unions,
                        influence: !wc.unions.influence
                    }))}>
