...
export default function ({cc, laws, sx}: { cc: CapitalistPlayer, laws: Record<LawId, LawLevel>, sx?: SxProps<Theme> }) {
    ...
    const [coverNeedsEarnings, setCoverNeedsEarnings] = useState(0);
    ...
    const preCapitalTaxRevenue = revenue + coverNeedsEarnings - totalWages - (operationalCompanies * calculateTaxMultiplier(laws.tax, laws.education, laws.health));
    ...
    return <Paper sx={{
        ...
        <Stack spacing={1}>
            ...
            <Stack spacing={1}>
                <Paper>
                    <FormLabel component="legend"><strong>Companies and Output</strong></FormLabel>
                ...
                <Paper>
                    ...
                    <CapitalistTaxes laws={laws} operationalCompanies={operationalCompanies}
                                     pretaxRevenue={revenue - totalWages + coverNeedsEarnings}/>
                </Paper>
                <Paper>
                    <Stack>
